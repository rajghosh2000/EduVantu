                            ...
                            if($res){
                                ...
                                echo'
                                    <div class="px-6">
                                        ...
                                        <a class="flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-600 rounded-md dark:bg-green-800 hover:bg-green-500 dark:hover:bg-green-700 focus:outline-none focus:bg-green-500 dark:focus:bg-green-700" href="_download.php?file_id='.$sfile.'">
