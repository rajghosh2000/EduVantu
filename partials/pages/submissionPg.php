                                ...
                                <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex flex-wrap justify-start">
                                    <div class="bg-white flex py-6 rounded shadow-lg mb-3">
                                        <div class="px-6">
                                            ...
                                            <a class="flex w-32 items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-600 rounded-md dark:bg-green-800 hover:bg-green-500 dark:hover:bg-green-700 focus:outline-none focus:bg-green-500 dark:focus:bg-green-700" href="#">
      ...
      if (strcmp($u_email, $uemail) == 0) {
        ...
        if ($noR > 0) {
          ...
          echo '
                                          ...
                                          <form action="_file.php?class=' . $aid . '" method="post" enctype="multipart/form-data">
                                              <div class="mt-12">
                                                <label for="name" class="leading-7 text-sm text-gray-600">Upload File</label><br>
                                                <input type="file" name="file" id="file" class="w-full bg-white bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out shadow-lg">
                                              </div>
                                              <br><br>
                                              <input type="submit" name="submit" value="Submit" class="text-black bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg shadow-xl w-full">
                                          </form>
                                        </div>
                                        ';
        }
        // ../../src/_submitAssign.php?class=' . $aid . '
      }
      echo '
                                </div>
                                </section>';
