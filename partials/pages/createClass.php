        ...
        echo'
            ...
            <body>
                <div class="flex flex-col h-screen">';
                    ...
                    echo'
                    <div class="flex max-w-sm mx-auto lg:mx-56 pt-4 pb-12 mt-8 mb-8 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl container">
                        ...
                        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                            <form>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input id="classcode" name="classcode" class="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="text">
                                </div>
                                <div class="mt-4">
                                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="classname">Class Name</label>
                                    <input id="classname" name="classname" class="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="text">
                                </div>
                                <div class="mt-4">
                                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="classdesc">Class Info</label>
                                    <textarea id="classdesc" name="classdesc" rows = "5" cols = "40" maxlength = "100" wrap class="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="email"></textarea>
                                </div>
