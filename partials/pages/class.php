            ...
            <div class="max-w-sm mx-auto lg:mx-4 overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800 lg:w-1/2">
               ...
               <?php //if(isset($_SESSION['signedIn']) && $_SESSION['signedIn']==true)
                ...
                <div class="px-6 mt-2">
                    ...
                    <div class="flex items-center text-gray-700 dark:text-gray-200 mt-4">
                        <svg class="svg-icon" viewBox="0 0 20 20" style="width: 5rem; height:5em;">
                        ...
                        <h2 class="inline-flex items-center justify-center text-xs font-bold tracking-tight text-green-800 px-2 ml-2">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque animi inventore nobis eius est, veniam qui, quod maiores labore facilis consequatur nulla magnam sunt illo, harum eos dolor non? Veniam.
                        </h2>
                    </div>
                    <div class="flex items-center text-gray-700 dark:text-gray-200 mt-4">
                        ...
                        <input type="text" value="Hello World" id="myInput" class="inline-flex items-center justify-center text-sm font-bold tracking-tight text-green-800 w-20" readonly="readonly">
                        <!-- <svg class="svg-icon" viewBox="0 0 20 20">
                        ...
                        <button onclick="myFunction()" class="flex items-center font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-transparent rounded-md dark:bg-transparent hover:bg-transparent dark:hover:bg-transparent focus:outline-none focus:bg-transparent dark:focus:bg-transparent">
