                                    ...
                                    <div class="container mr-20 flex flex-wrap">
                                        <div class="flex relative pt-10 pb-10 sm:items-center md:w-full mx-auto">
                                            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row ">
                                                <a class="flex-shrink-0 w-20 h-20 bg-green-100 text-green-500 rounded-full inline-flex items-center justify-center shadow-lg" href="#" data-toggle="tooltip" title="Create Assignment">
