                        ...
                        <div class="container px-5 py-10 mx-auto">
                            <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                                <div class="sm:w-1/2 mb-10 px-4">
                                    ...
                                    <button
                                        class="rounded-full h-24 w-24 flex items-center justify-center shadow mx-auto mt-6 text-white bg-green-700 border-0 py-2 px-5 focus:outline-none hover:bg-green-900"><a href="createClass.php"><svg
